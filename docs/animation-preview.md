...
> **Archived reference for AzureSlop 0.7.** These commands are absent from the
> current CLI and plugin; the old source is in [legacy](../legacy/README.md).
> For current agent control, use
